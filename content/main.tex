...
Every attempt towards a modified theory of gravity has to take Lovelock's theorem into consideration and break at least one of its assumptions that make general relativity unique. The concept of the entire class of \fR{theories}, for example, is to replace the Ricci scalar \(\Rscal\) in the \namedeqref{Einstein-Hilbert action}{eq:einstein_hilbert_action} by a function \(f(\Rscal)\).
