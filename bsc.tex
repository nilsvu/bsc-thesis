...
Because of its symmetry condition\todo{add reference or derive}, \(\delta g\) has 10 degrees of freedom that we can parametrize as \autocite{Schulz}
\begin{align}
...
\begin{itemize}
	...
	\item where \(\Gtens_{\mu\nu}\) is divergence-free. \todo{is this equivalent to local and lorentz inv., bianchi?}
\end{itemize}
...
An increase in propagation speed of gravitational waves relative to the speed of light is also in agreement with observational data \autocite{Raveri2014}. Since the gravitational effect could be measured before light emitted by the same source, the causal structure of the theory must be reconsidered. \todo{discuss this}
